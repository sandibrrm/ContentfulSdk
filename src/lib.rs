// src/lib.rs
/*
 * Core library for ContentfulSdk
 */
...
#[derive(Debug)]
pub struct ContentfulSdkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ContentfulSdkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ContentfulSdk processing");
    
    let mut processor = ContentfulSdkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ContentfulSdkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ContentfulSdkProcessor::new(false);
